...
const Navbar = () => {
  ...
  return (
    <div className="lg:flex lg:justify-between lg:items-center lg:p-x-15 lg:pr-4 lg:px-4 bg-main-bg-600 sticky top-0 h-m130 z-50 text-lg">
      ...
      <div className="hidden lg:block" style={{ flex: 3 }}>
        <ul className="p-0 flex items-center justify-center list-none text-white font-[600]">
          <Link href="/">
            <li className="cursor-pointer m-5">Home</li>
          </Link>
          <Image src="/img/buchislogo.png" alt="logo" width="160" height="80" />
          <Link href="/contact-us">
            <li className="cursor-pointer m-5">Contact</li>
          </Link>
        </ul>
      </div>

      <div className="hidden flex-1 lg:flex justify-end items-center">
        <div className="inline-flex text-white font-my500 cursor-pointer pr-6 mr-6">
